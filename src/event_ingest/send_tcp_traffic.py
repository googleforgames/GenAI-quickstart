...
# NOTE: This script is used for adhoc testing. It can be removed or edited at anytime.
...
def send_tcp(json_payload, host, port):
    ...
    print('Waiting for TCP server response...')
    data = sock.recv(1024)
...
if __name__ == "__main__":
    ...
    send_tcp(json_payload=data_payload, host=args.host, port=args.port)
